...
> 注意！如果某些操作不起作用，请运行 `ifdown -v <iface>; ifup -v <iface>` 并检查输出！
...
注意：在 U-Boot 控制台中输入命令来启用 wifi 设备
...
### WLAN0 | HI3518EV200 | CIP37210 和 HS303v1
...
### WLAN0 | HI3518EV200 | HS303v3 和 IPC-136W
...
### WLAN0 | T31 + ATBM6031 SDIO |威兹 V3，HL-CAM04
